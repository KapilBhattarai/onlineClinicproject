        ...
        <div id="locator">
            <!-- your form controls -->
                    <div class="panel-heading" id= "locator1">
                        <div class="panel-title" >Please Send Feedback To Your Patient</div>
                    </div>
                    
                 <div style="padding-top:30px" class="panel-body" >

  <spring:form id="doctorFeedbackform" class="form-horizontal" role="form" action="${pageContext.request.contextPath}/doctorFeedback" method="post"  modelAttribute="Appinfo">
						...
						<div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <spring:textarea path="docFeedback" rows="5" cols="39" name="msg"/>
                             </div>
